...
export default function SalaryRaiseCalculator() {
  ...
  </div><div className="result"><small>Gaji setelah kenaikan</small><strong>{rupiah.format(newSalary)}</strong><p>Dari {rupiah.format(salary)} dengan kenaikan {percent || 0}%.</p></div></div>;
}
